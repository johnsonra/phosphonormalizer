#' Enriched dataset
#'
#' A dataset containing sequences, modifications and abundances of about 4000 peptides 
#' over 5 samples with 3 technical replicates each.
#' 
#'
#' @format A data frame with 4099 rows and 17 variables, all samples are median normalized:
#' \describe{
